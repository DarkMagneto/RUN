...
DarckAsce_aff_debut("inscription", 'http://localhost/PWA/img/bgv192svg.svg','http://localhost/PWA/style.css',"http://localhost/PWA/index.js");

Darck_aff_menu($pseudo='', $droits = array(false, false), $prefix = '..');
